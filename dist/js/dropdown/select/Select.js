...
var renderThumbVerticalDefault = function renderThumbVerticalDefault(_ref) {
...
var renderTrackVerticalDefault = function renderTrackVerticalDefault(_ref2) {
...
var Select = _react2.default.createClass({
	...
	propTypes: {
		...
		onScrollMenu: _react2.default.PropTypes.func, // Menu is scrolled
	...
	componentDidUpdate: function componentDidUpdate(prevProps) {
		...
		if (this._scrollToFocusedOptionOnUpdate && this.focused && this.menu) {
			...
			this.menuScrollbar.refs.view.scrollTop = focusedDOM.offsetTop;
		}
	...
	renderOuter: function renderOuter(options, valueArray, focusedOption) {
		...
		if (menu && menu.length > 3) {
			menu = _react2.default.createElement(
				...
				{ ref: function ref(item) {
						return _this7.menuScrollbar = item;
					}, style: { height: 120 }, hideTracksWhenNotNeeded: true, renderTrackVertical: renderTrackVerticalDefault, renderThumbVertical: renderThumbVerticalDefault },
				_react2.default.createElement(
					'div',
		...
		return _react2.default.createElement(
			...
			{ ref: function ref(_ref7) {
					return _this7.menuContainer = _ref7;
				}, className: 'Select-menu-outer', style: this.props.menuContainerStyle },
			_react2.default.createElement(
				'div',
				{ ref: function ref(_ref6) {
						return _this7.menu = _ref6;
